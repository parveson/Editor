...
if not Request.Form("submitted") then
	...
	%>
	<h3 align="center">Close a Review File</h3>
	<p><STRONG>Are you sure you wish to close this file?</STRONG> 
	<p>Note:  You may close a file if you wish to submit a revised version.</p> 
