...
<br>
<h3 align="center">List of all Members</h3>
<% 
...
if not Request.Form("submitted")then %> 
	<p><i><b>Click on any name to view/edit/delete the Detail data.</b></i>
	<small><br><b>Key:</b><br>
	Occupations: 1=student, 2=private sector, 3=public sector, 4=nonprofit, 5=consultant, 6=other, 7=unknown<br> 
	Roles: 1=admin, 2=associate, 3=partner, 4=vendor, 5=member<br></small>
	</p>
	...
	' Set the status fields to False (not blocked) for all records
	set rs=Server.CreateObject("ADODB.Recordset")
	for each Item in Request.Form
...
%>
<p><a href="admin.asp?id=<%=loginid%>">Return to admin page</a></p>
</body>
</html>
